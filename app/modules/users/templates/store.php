...
<div class="col-12 col-md-11">
    <div class="app-card app-card-settings shadow-sm p-4">
        <div class="app-card-body">
            <form action="/user/create" method="POST" enctype="multipart/form-data" class="settings-form">
                <div class="mb-3">
                    <label for="name" class="form-label">
                        <?= $data->label->get('table_username', 'User Name') ?>
                    </label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Lorem Ipsum Ltd." required="">
                </div>
                <div class="mb-3">
