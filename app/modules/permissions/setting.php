...
class Setting
{
    ...
    public static array $details = [
        ...
        "children" => [
            [
                ...
                "name" => "permission",
                "status" => "enable",
                "description" => "permission of actions to groups",
            ],
            [
                "model" => "usergroup",
                "name" => "user group",
                "status" => "enable",
                "description" => "relation users on group",
            ]
        ]
    ];
    ...
    public $route = [
        ...
        [
            "method" => "POST",
            "module" => "Permission",
            "url" => "permission/switch/{guide}",
            "function" => "switch",
        ],
        [
            "method" => "POST",
            "module" => "Permission",
            "url" => "permission/update/{guide}",
            "function" => "update",
        ],
        [
            "method" => "GET|POST|DELETE",
            "module" => "Permission",
            "url" => "permission/delete/{guide}",
            "function" => "destroy",
        ],
        [
            "module" => "Permission",
